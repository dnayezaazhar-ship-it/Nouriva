...
export type NativeBiometricCredentialModule = {
    getTrustedDeviceAvailability(id: string | null, identifierHint: string | null): Promise<BiometricCredentialAvailability>;
    listTrustedDevices(): Promise<NativeBiometricCredential[]>;
    enrollTrustedDevice(deviceName: string | null, identifierHint: string | null, reason: string | null, policy: BiometricCredentialPolicy): Promise<NativeBiometricCredential>;
    revokeTrustedDevice(id: string): Promise<NativeBiometricCredential>;
    signInWithTrustedDevice(id: string | null, identifierHint: string | null, reason: string | null): Promise<NativeBiometricSignInResult>;
};
//# sourceMappingURL=NativeClerkModule.types.d.ts.map
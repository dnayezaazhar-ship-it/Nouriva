...
//#region ../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/index.js
var require_build = /* @__PURE__ */ require_runtime.__commonJSMin(((exports) => {
	...
	function AndroidConfig() {
		const data = _interopRequireWildcard(require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/android"));
	...
	function IOSConfig() {
		const data = _interopRequireWildcard(require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/ios"));
		IOSConfig = function() {
			return data;
		};
		return data;
	...
	function _createBaseMod() {
		const data = require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/plugins/createBaseMod");
	...
	function _withAndroidBaseMods() {
		const data = require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/plugins/withAndroidBaseMods");
	...
	function _withIosBaseMods() {
		const data = require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/plugins/withIosBaseMods");
	...
	function XML() {
		const data = _interopRequireWildcard(require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/utils/XML"));
		XML = function() {
			return data;
		};
		return data;
	...
	function CodeGenerator() {
		const data = _interopRequireWildcard(require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/utils/generateCode"));
	...
	function History() {
		const data = _interopRequireWildcard(require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/utils/history"));
		History = function() {
			return data;
		};
		return data;
	...
	function WarningAggregator() {
		const data = _interopRequireWildcard(require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/utils/warnings"));
	...
	function _Updates() {
		const data = _interopRequireWildcard(require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/utils/Updates"));
		_Updates = function() {
			return data;
		};
		return data;
	...
	var _Plugin = require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/Plugin.types");
	...
	function _withPlugins() {
		const data = require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/plugins/withPlugins");
	...
	function _withRunOnce() {
		const data = require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/plugins/withRunOnce");
	...
	function _withDangerousMod() {
		const data = require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/plugins/withDangerousMod");
	...
	function _withFinalizedMod() {
		const data = require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/plugins/withFinalizedMod");
	...
	function _withMod() {
		const data = require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/plugins/withMod");
		_withMod = function() {
			return data;
		};
		return data;
	...
	function _iosPlugins() {
		const data = require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/plugins/ios-plugins");
	...
	function _androidPlugins() {
		const data = require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/plugins/android-plugins");
	...
	function _validations() {
		const data = require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/utils/validations");
	...
	function _withStaticPlugin() {
		const data = require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/plugins/withStaticPlugin");
	...
	function _modCompiler() {
		const data = require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/plugins/mod-compiler");
	...
	function _errors() {
		const data = require("../../../../../../../../../../node_modules/.pnpm/@expo+config-plugins@54.0.5/node_modules/@expo/config-plugins/build/utils/errors");
		_errors = function() {
			return data;
		};
		return data;

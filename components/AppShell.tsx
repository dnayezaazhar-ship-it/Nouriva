...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="app-layout">
    <aside className="sidebar">
      ...
      <div className="sidebar-bottom"><Link href="/pricing" className="upgrade-card"><span>✦</span><b>Go further</b><small>Explore Nouriva plans</small></Link><button type="button" className="profile-link" onClick={() => void openProfile()}>⚙ <span>Edit Profile</span></button><div className="user-row"><UserButton afterSignOutUrl="/" /><span>Your account</span></div></div>
    </aside>

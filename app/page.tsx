    ...
    <main>
      ...
      <section className="hero">
        ...
        <div className="hero-art" aria-label="Nouriva nutrition dashboard preview">
          ...
          <div className="dash-card dash-main"><div className="dash-header"><span>Tuesday, October 8</span><span className="status-dot">● On track</span></div><h3>Your nourishment today</h3><div className="progress-ring"><div><strong>72</strong><small>%</small><span>balanced</span></div></div><div className="macro-row"><div><span className="macro-bar green" /><b>Protein</b><small>86g / 110g</small></div><div><span className="macro-bar coral" /><b>Fiber</b><small>19g / 28g</small></div><div><span className="macro-bar gold" /><b>Water</b><small>5 / 8 cups</small></div></div></div>
